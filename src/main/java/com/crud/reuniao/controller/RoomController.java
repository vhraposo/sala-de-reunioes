...
import com.crud.reuniao.exception.ResourceNotFoundException;
import com.crud.reuniao.model.Room;
import com.crud.reuniao.repository.RoomRepository;
...
public class RoomController {
    ...
    public ResponseEntity<Room> updateRoom(@PathVariable(value = "id") Long roomId, @Valid @RequestBody Room roomDetails) throws ResourceNotFoundException{
        Room room = roomRepository.findById(roomId).orElseThrow(() -> new ResourceNotFoundException("Sala não encontrada com esse id::" + roomId));
    ...
    @DeleteMapping("/rooms/{id}")
     public Map<String, Boolean> deleteRoom(@PathVariable(value = "id") Long roomId) throws ResourceNotFoundException{
        Room room = roomRepository.findById(roomId)
        .orElseThrow(()-> new ResourceNotFoundException("Sala não encontrada com esse id::" + roomId));
